...
export default {
  ...
  methods: {
    ...
    marioCircuit() {
      this.currentTrack = "mario_circuit";
      this.trackName = "Mario Circuit";
    },
    toadHarbor() {
      this.currentTrack = "toad_harbor";
      this.trackName = "Toad Harbor";
    },
    twistedMansion() {
      this.currentTrack = "twisted_mansion";
      this.trackName = "Twisted Mansion";
    },
    shyGuyFalls() {
      this.currentTrack = "shy_guy_falls";
      this.trackName = "Shy Guy Falls";
    },
    async getItems() {
      try {
