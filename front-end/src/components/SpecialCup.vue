<template>
  <div class="wrapper">
    ...
    <div class="section">
      <div class="tracks">
        <img src="~@/assets/data/courses/tracks/special/cloudtop_cruise.webp" @click="show(); cloudtopCruise()" @mouseover="playHover()">
        <img src="~@/assets/data/courses/tracks/special/bone-dry_dunes.webp" @click="show(); boneDryDunes()" @mouseover="playHover()">
        <img src="~@/assets/data/courses/tracks/special/bowser's_castle.webp" @click="show(); bowsersCastle()" @mouseover="playHover()">
        <img src="~@/assets/data/courses/tracks/special/rainbow_road.webp" @click="show(); rainbowRoad()" @mouseover="playHover()">
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    cloudtopCruise() {
      this.currentTrack = "cloudtop_cruise";
      this.trackName = "Cloudtop Cruise";
    },
    boneDryDunes() {
      this.currentTrack = "bone-dry_dunes";
      this.trackName = "Bone-Dry Dunes";
    },
    bowsersCastle() {
      this.currentTrack = "bowser's_castle";
      this.trackName = "Bowser's Castle";
    },
    rainbowRoad() {
      this.currentTrack = "rainbow_road";
