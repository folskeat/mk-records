<template>
  <div class="wrapper">
    <div class="section">
      <div class="tracks">
        <img src="~@/assets/data/courses/tracks/special/cloudtop_cruise.webp" @click="show(); cloudtopCruise()">
        <img src="~@/assets/data/courses/tracks/special/bone-dry_dunes.webp" @click="show(); boneDryDunes()">
        <img src="~@/assets/data/courses/tracks/special/bowser's_castle.webp" @click="show(); bowsersCastle()">
        <img src="~@/assets/data/courses/tracks/special/rainbow_road.webp" @click="show(); rainbowRoad()">
      </div>
    </div>
