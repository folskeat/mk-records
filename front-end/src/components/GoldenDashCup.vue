<template>
  <div class="wrapper">
    <div class="section">
      <div class="tracks">
        <img src="~@/assets/data/courses/tracks/golden-dash/paris_promenade.png" @click="show(); parisPromenade()">
        <img src="~@/assets/data/courses/tracks/golden-dash/toad_circuit.png" @click="show(); toadCircuit()">
        <img src="~@/assets/data/courses/tracks/golden-dash/choco_mountain.png" @click="show(); chocoMountain()">
        <img src="~@/assets/data/courses/tracks/golden-dash/coconut_mall.png" @click="show(); coconutMall()">
      </div>
    </div>
