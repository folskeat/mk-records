<template>
  <div class="wrapper">
    ...
    <div class="section">
      <div class="tracks">
        <img src="~@/assets/data/courses/tracks/golden-dash/paris_promenade.png" @click="show(); parisPromenade()" @mouseover="playHover()">
        <img src="~@/assets/data/courses/tracks/golden-dash/toad_circuit.png" @click="show(); toadCircuit()" @mouseover="playHover()">
        <img src="~@/assets/data/courses/tracks/golden-dash/choco_mountain.png" @click="show(); chocoMountain()" @mouseover="playHover()">
        <img src="~@/assets/data/courses/tracks/golden-dash/coconut_mall.png" @click="show(); coconutMall()" @mouseover="playHover()">
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    parisPromenade() {
      this.currentTrack = "tour_paris_promenade";
      this.trackName = "Paris Promenade";
    },
    toadCircuit() {
      this.currentTrack = "3ds_toad_circuit";
      this.trackName = "Toad Circuit";
    },
    chocoMountain() {
      this.currentTrack = "n64_choco_mountain";
      this.trackName = "Choco Mountain";
    },
    coconutMall() {
      this.currentTrack = "wii_coconut_mall";
      this.trackName = "Coconut Mall";
    },
    async getItems() {
      try {
