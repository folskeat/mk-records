...
export default {
  ...
  methods: {
    ...
    sunshineAirport() {
      this.currentTrack = "sunshine_airport";
      this.trackName = "Sunshine Airport";
    },
    dolphinShoals() {
      this.currentTrack = "dolphin_shoals";
      this.trackName = "Dolphin Shoals";
    },
    electrodrome() {
      this.currentTrack = "electrodrome";
      this.trackName = "Electrodrome";
    },
    mountWario() {
      this.currentTrack = "mount_wario";
      this.trackName = "Mount Wario";
    },
    async getItems() {
      try {
