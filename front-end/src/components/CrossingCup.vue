<template>
  <div class="wrapper">
    <div class="section">
      <div class="tracks">
        <img src="~@/assets/data/courses/tracks/crossing/baby_park.webp" @click="show(); babyPark()">
        <img src="~@/assets/data/courses/tracks/crossing/cheese_land.webp" @click="show(); cheeseLand()">
        <img src="~@/assets/data/courses/tracks/crossing/wild_woods.webp" @click="show(); wildWoods()">
        <img src="~@/assets/data/courses/tracks/crossing/animal_crossing.webp" @click="show(); animalCrossing()">
      </div>
    </div>
