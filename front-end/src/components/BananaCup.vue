...
export default {
  ...
  methods: {
    ...
    dryDryDesert() {
      this.currentTrack = "gcn_dry_dry_desert";
      this.trackName = "Dry Dry Desert";
    },
    donutPlains3() {
      this.currentTrack = "snes_donut_plains_3";
      this.trackName = "Donut Plains 3";
    },
    royalRaceway() {
      this.currentTrack = "n64_royal_raceway";
      this.trackName = "Royal Raceway";
    },
    dkJungle() {
      this.currentTrack = "3ds_dk_jungle";
      this.trackName = "DK Jungle";
    },
    async getItems() {
      try {
