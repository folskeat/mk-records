<template>
  <div class="wrapper">
    <div class="section">
      <div class="tracks">
        <img src="~@/assets/data/courses/tracks/egg/yoshi_circuit.webp" @click="show(); yoshiCircuit()">
        <img src="~@/assets/data/courses/tracks/egg/excitebike_arena.webp" @click="show(); excitebikeArena()">
        <img src="~@/assets/data/courses/tracks/egg/dragon_driftway.webp" @click="show(); dragonDriftway()">
        <img src="~@/assets/data/courses/tracks/egg/mute_city.webp" @click="show(); muteCity()">
      </div>
    </div>
