<template>
  <div class="wrapper">
    ...
    <div class="section">
      <div class="tracks">
        <img src="~@/assets/data/courses/tracks/egg/yoshi_circuit.webp" @click="show(); yoshiCircuit()" @mouseover="playHover()">
        <img src="~@/assets/data/courses/tracks/egg/excitebike_arena.webp" @click="show(); excitebikeArena()" @mouseover="playHover()">
        <img src="~@/assets/data/courses/tracks/egg/dragon_driftway.webp" @click="show(); dragonDriftway()" @mouseover="playHover()">
        <img src="~@/assets/data/courses/tracks/egg/mute_city.webp" @click="show(); muteCity()" @mouseover="playHover()">
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    yoshiCircuit() {
      this.currentTrack = "gba_yoshi_circuit";
      this.trackName = "Yoshi Circuit";
    },
    excitebikeArena() {
      this.currentTrack = "excitebike_arena";
      this.trackName = "Excitebike Arena";
    },
    dragonDriftway() {
      this.currentTrack = "dragon_driftway";
      this.trackName = "Dragon Driftway";
    },
    muteCity() {
      this.currentTrack = "mute_city";
      this.trackName = "Mute City";
    },
    async getItems() {
      try {
