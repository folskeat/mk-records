...
export default {
  ...
  methods: {
    ...
    wariosGoldMine() {
      this.currentTrack = "wii_wario's_gold_mine";
      this.trackName = "Wario's Gold Mine";
    },
    rainbowRoad() {
      this.currentTrack = "snes_rainbow_road";
      this.trackName = "Rainbow Road";
    },
    iceIceOutpost() {
      this.currentTrack = "ice_ice_outpost";
      this.trackName = "Ice Ice Outpost";
    },
    hyruleCircuit() {
      this.currentTrack = "hyrule_circuit";
      this.trackName = "Hyrule Circuit";
    },
    async getItems() {
      try {
